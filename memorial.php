...
<head>
  ...
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
  <meta charset="utf-8">
  <title>2014 Memorial</title>
  <meta name="description" content="">
  <meta name="author" content="Right of way">
...
<body>
    ...
    <div class="container">
      <div class="row">
        <div class="one-half column title">
          <a href="http://www.rightofway.org"><h2>RIGHT OF WAY</h2></a>
          <h2>2014 memorial</h2>
        </div>
      </div>
    </div>
  ...
  <div class="section photo-strip">
    <div class="container">
      ...
      <div class ="row main-text">
        <h4>On April 18th, Right of Way installed a memorial for 264 victims of traffic violence on Kent Avenue in Brooklyn. <a href="http://www.rightofway.org/campaigns/vision-264">Click here to read the full report</a>. 
        </h4>
      </div>
    </div>
  </div>
  ...
  <div class="section the-map">
    <div class="container">
      <h3><center>Map of those killed in 2014</center></h3>
      <div id="map"></div>
    </div>
  </div>
 ...
 <div class="section">
  <div class="container bottom-note">
    <p>* After we created our artwork, the total deaths rose to 269 from 264.</p>
    <p>Source code for the website and artwork <a href="https://github.com/aepyornis/row-memorial-2014">available here</a></p>
  </div>
</dvi>
